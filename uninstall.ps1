...
if ($problems.Count -eq 0) {
    $removeOk = $true
    foreach ($name in @('clipwarp.ps1', 'clipwarp-watch.ps1', 'clipwarp-calendar.psm1', 'clipwarp-calendar-popup.ps1', 'clipwarp-support.psm1', 'clipwarp-clipboard.cs', 'clipwarp-watch.pid', 'clipwarp-watch.log')) {
